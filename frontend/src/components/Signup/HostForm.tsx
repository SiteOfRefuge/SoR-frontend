...
export default function RefugeeSignupForm({
  ...
  const allowedPeople = useController({
    control,
    name: "summary.allowed_people",
    defaultValue: 0,
  })
  ...
  return (
    <form onSubmit={onSubmit}>
      <VStack spacing="16px" p="5">
        ...
        <Calendar
          isActive={!getValues("summary.availability.active")}
          onChange={dateAvailable.field.onChange}
          value={dateAvailable.field.value}
        />
        <FormControl>
          <FormLabel htmlFor="region">
